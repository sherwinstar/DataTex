...
#include <memory>
#include "datatex/keygenerator.h"
...
void KeyGenerator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: { QString _r = _t->password((*reinterpret_cast< QString(*)>(_a[1])));
        ...
        {
            using _t = QString (KeyGenerator::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&KeyGenerator::password)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
QString KeyGenerator::password(QString _t1)
{
    QString _t0{};
